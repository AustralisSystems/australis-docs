# Quick Start Guide - Instruction System v3
...
- The templates below are v2-era and are retained temporarily for reference.
- v3 usage is YAML-only and schema-validated; prefer authoring against the v3 schemas.

**Version**: v3 (in progress)
**Last Updated**: 2026-01-21
**Purpose**: Copy-paste starting points for v3 MCP prompt authoring
